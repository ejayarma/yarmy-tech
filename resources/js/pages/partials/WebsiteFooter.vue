<template>
    <!-- <footer class="border-t border-gray-200 py-8">
        <div class="max-w-6xl mx-auto px-4 text-center text-gray-600">
            <p class="tracking-wider font-medium">Delightfully simple software</p>
            <p class="text-sm mt-4">&copy; {{ new Date().getFullYear() }} Yarmy Technologies. All rights reserved.</p>
        </div>
    </footer> -->
    <footer class="border-t border-gray-200">
        <div class="relative  bg-primary text-slate-50  -mt-5 shadow-3xl shadow-inner  ">
        <div
            class="absolute inset-0 h-full w-full bg-transparent bg-[radial-gradient(#2563eb_1px,transparent_1px)] [background-size:16px_16px] [mask-image:radial-gradient(ellipse_50%_50%_at_50%_50%,#000_60%,transparent_100%)]">
        </div>

        <!-- <div class="max-w-4xl mx-auto px-4 text-center"></div> -->
        <div
            ...
            <div class="flex gap-4">
                <svg class="size-10 md:size-16 fill-secondary" id="a" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 498.573 463.864">
            ...
            <div class="tracking-wider">
                ...
                <ul class="mt-2">
                    ...
                    <li>
                        <a href="/service" class="block py-1">Our Services</a>
                    </li>
                    <li>
                        <a href="/contact" class="block py-1">Reach us</a>
                    </li>
                </ul>
            </div>
            <div class="tracking-wider">
        ...
        <p class="relative py-1 text-sm  text-center text-gray-700 bg-white ">
            &copy; {{ new Date().getFullYear() }} <span class="text-xs">●</span> Yarmy Technologies. ❤️ All rights reserved
        </p>
    </div>
    </footer>
</template>
